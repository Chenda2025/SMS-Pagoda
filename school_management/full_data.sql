...
--
-- Name: assign_class_monitor(integer, integer, integer, character varying); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.assign_class_monitor(p_student_id integer, p_classroom_id integer, p_academic_year_id integer, p_role character varying DEFAULT 'monitor'::character varying) RETURNS TABLE(success boolean, message character varying)
    LANGUAGE plpgsql
    AS $$
BEGIN
    INSERT INTO class_monitors 
        (student_id, classroom_id, academic_year_id, role, appointed_date)
    VALUES 
        (p_student_id, p_classroom_id, p_academic_year_id, p_role, CURRENT_DATE)
    ON CONFLICT (classroom_id, academic_year_id, role)
    DO UPDATE SET student_id = p_student_id;

    RETURN QUERY SELECT true, 'បានកំណត់ក្រុមលួច'::VARCHAR;
END;
$$;


ALTER FUNCTION public.assign_class_monitor(p_student_id integer, p_classroom_id integer, p_academic_year_id integer, p_role character varying) OWNER TO postgres;

--
-- Name: calculate_monthly_average(integer, integer, integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.calculate_monthly_average(p_student_id integer, p_academic_year_id integer, p_month_period_id integer) RETURNS numeric
    LANGUAGE plpgsql
    AS $$
DECLARE
    v_average NUMERIC;
BEGIN
    SELECT ROUND(AVG(final_score)::NUMERIC, 2)
    INTO v_average
    FROM final_scores fs
    WHERE fs.student_id = p_student_id
      AND fs.period_id = p_month_period_id
      AND fs.period_id IN (
...
ALTER FUNCTION public.calculate_monthly_average(p_student_id integer, p_academic_year_id integer, p_month_period_id integer) OWNER TO postgres;

--
-- Name: enroll_student(integer, integer, integer, date); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.enroll_student(p_student_id integer, p_classroom_id integer, p_academic_year_id integer, p_enrollment_date date DEFAULT CURRENT_DATE) RETURNS TABLE(success boolean, message character varying, enrollment_id integer)
    LANGUAGE plpgsql
    AS $$
DECLARE
    v_enrollment_id INT;
...
BEGIN
    ...
    IF NOT v_student_exists THEN
        RETURN QUERY SELECT false, 'ស្ិស្សមិនឡើង'::VARCHAR, NULL::INT;
        RETURN;
    END IF;

    -- Validate classroom exists
    SELECT EXISTS(SELECT 1 FROM classrooms WHERE id = p_classroom_id) INTO v_classroom_exists;
    IF NOT v_classroom_exists THEN
        RETURN QUERY SELECT false, 'ឆ្នាក់មិនឡើង'::VARCHAR, NULL::INT;
        RETURN;
    END IF;
    ...
    IF v_already_enrolled THEN
        RETURN QUERY SELECT false, 'ស្ិស្សបានចុះឈ្មោះរួចហើយ'::VARCHAR, NULL::INT;
        RETURN;
    END IF;

    -- Insert enrollment
    INSERT INTO enrollments (student_id, classroom_id, academic_year_id, enrollment_date)
    VALUES (p_student_id, p_classroom_id, p_academic_year_id, p_enrollment_date)
    RETURNING id INTO v_enrollment_id;

    RETURN QUERY SELECT true, 'បានចុះឈ្មោះដោយជោគជ័យ'::VARCHAR, v_enrollment_id;
END;
$$;


ALTER FUNCTION public.enroll_student(p_student_id integer, p_classroom_id integer, p_academic_year_id integer, p_enrollment_date date) OWNER TO postgres;

--
-- Name: generate_report_card(integer, integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.generate_report_card(p_student_id integer, p_academic_year_id integer) RETURNS TABLE(student_code character varying, student_name character varying, class_name character varying, subject_name character varying, attendance_score numeric, homework_score numeric, exercise_score numeric, exam_score numeric, final_score numeric)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY
    ...
    LEFT JOIN final_scores fs ON fs.student_id = s.id
        AND fs.subject_id = subj.id
        AND fs.period_id IN (
            SELECT id FROM academic_periods 
            WHERE academic_year_id = p_academic_year_id
        )
...
ALTER FUNCTION public.generate_report_card(p_student_id integer, p_academic_year_id integer) OWNER TO postgres;

--
-- Name: get_academic_year_info(integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_academic_year_info(p_academic_year_id integer) RETURNS TABLE(year_name character varying, start_date date, end_date date, is_current boolean, days_remaining integer)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY
...
ALTER FUNCTION public.get_academic_year_info(p_academic_year_id integer) OWNER TO postgres;

--
-- Name: get_attendance_rate(integer, integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_attendance_rate(p_student_id integer, p_academic_year_id integer) RETURNS numeric
    LANGUAGE plpgsql
    AS $$
DECLARE
    v_present_count INT;
...
BEGIN
    ...
    v_rate := ROUND((v_present_count::NUMERIC / v_total_count) * 100, 2);
    RETURN v_rate;
END;
$$;


ALTER FUNCTION public.get_attendance_rate(p_student_id integer, p_academic_year_id integer) OWNER TO postgres;

--
-- Name: get_class_monitors(integer, integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_class_monitors(p_classroom_id integer, p_academic_year_id integer) RETURNS TABLE(role character varying, student_code character varying, student_name character varying, appointed_date date)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY
    ...
    WHERE cm.classroom_id = p_classroom_id
      AND cm.academic_year_id = p_academic_year_id
    ORDER BY cm.role;
END;
$$;


ALTER FUNCTION public.get_class_monitors(p_classroom_id integer, p_academic_year_id integer) OWNER TO postgres;

--
-- Name: get_class_rankings(integer, integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_class_rankings(p_classroom_id integer, p_academic_year_id integer) RETURNS TABLE(rank bigint, student_id integer, student_code character varying, student_name character varying, average_score numeric, mention character varying)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY
    WITH student_averages AS (
        SELECT 
            ...
            ROW_NUMBER() OVER (ORDER BY AVG(fs.final_score) DESC) AS rank_num,
            CASE 
                WHEN AVG(fs.final_score) >= 45 THEN 'ល្អប្រសើរ'
                WHEN AVG(fs.final_score) >= 40 THEN 'ល្អណាស់'
                WHEN AVG(fs.final_score) >= 35 THEN 'ល្អ'
                WHEN AVG(fs.final_score) >= 30 THEN 'ល្អបង្គួរ'
                WHEN AVG(fs.final_score) >= 25 THEN 'មធ្យម'
                ELSE 'ខ្សោយ'
            END AS mention_grade
        FROM enrollments e
        JOIN students s ON s.id = e.student_id
        LEFT JOIN final_scores fs ON fs.student_id = e.student_id
            AND fs.period_id IN (
                SELECT id FROM academic_periods 
                WHERE academic_year_id = p_academic_year_id
            )
        WHERE e.classroom_id = p_classroom_id 
          AND e.academic_year_id = p_academic_year_id
        GROUP BY e.student_id, s.student_code, s.first_name, s.last_name
    )
    SELECT 
        rank_num,
        student_id,
...
ALTER FUNCTION public.get_class_rankings(p_classroom_id integer, p_academic_year_id integer) OWNER TO postgres;

--
-- Name: get_class_statistics(integer, integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_class_statistics(p_classroom_id integer, p_academic_year_id integer) RETURNS TABLE(total_students integer, present_count integer, absent_count integer, average_score numeric, highest_score numeric, lowest_score numeric, pass_rate numeric)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY
    WITH class_stats AS (
        SELECT 
            COUNT(DISTINCT e.student_id) AS total_st,
            COUNT(DISTINCT CASE WHEN att.status = 'present' THEN att.student_id END) AS present_st,
            COUNT(DISTINCT CASE WHEN att.status = 'absent' THEN att.student_id END) AS absent_st,
            ROUND(AVG(fs.final_score), 2) AS avg_sc,
            ROUND(MAX(fs.final_score), 2) AS max_sc,
            ROUND(MIN(fs.final_score), 2) AS min_sc,
            ROUND(100.0 * COUNT(CASE WHEN fs.final_score >= 50 THEN 1 END) / 
                  NULLIF(COUNT(DISTINCT e.student_id), 0), 2) AS pass_rt
        FROM enrollments e
        LEFT JOIN attendance att ON att.student_id = e.student_id
            AND att.academic_year_id = p_academic_year_id
        LEFT JOIN final_scores fs ON fs.student_id = e.student_id
            AND fs.period_id IN (
                SELECT id FROM academic_periods 
                WHERE academic_year_id = p_academic_year_id
...
ALTER FUNCTION public.get_class_statistics(p_classroom_id integer, p_academic_year_id integer) OWNER TO postgres;

--
-- Name: get_current_academic_year(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_current_academic_year() RETURNS TABLE(id integer, year_name character varying, start_date date, end_date date)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY
...
--
-- Name: get_payment_status(integer, integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_payment_status(p_student_id integer, p_academic_year_id integer) RETURNS TABLE(amount_due numeric, amount_paid numeric, balance numeric, status character varying)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY
    SELECT 
        ...
        spy.balance,
        spy.status
    FROM student_pay_year spy
    WHERE spy.student_id = p_student_id
      AND spy.academic_year_id = p_academic_year_id;
END;
$$;


ALTER FUNCTION public.get_payment_status(p_student_id integer, p_academic_year_id integer) OWNER TO postgres;

--
-- Name: grant_user_permission(integer, integer, integer, text, date); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.grant_user_permission(p_user_id integer, p_permission_id integer, p_granted_by integer, p_reason text DEFAULT NULL::text, p_expiry_date date DEFAULT NULL::date) RETURNS TABLE(success boolean, message character varying)
    LANGUAGE plpgsql
    AS $$
DECLARE
...
BEGIN
    ...
    IF NOT v_user_exists THEN
        RETURN QUERY SELECT false, 'ប្រើប្រាស់មិនឡើង'::VARCHAR;
        RETURN;
    END IF;

    -- Validate permission
    SELECT EXISTS(SELECT 1 FROM permissions WHERE id = p_permission_id) INTO v_perm_exists;
    IF NOT v_perm_exists THEN
        RETURN QUERY SELECT false, 'សិទ្ធមិនឡើង'::VARCHAR;
        RETURN;
    END IF;

    -- Insert or update permission
    INSERT INTO user_permissions 
        (user_id, permission_id, grant_type, granted_by, reason, expiry_date)
    VALUES 
        (p_user_id, p_permission_id, 'grant', p_granted_by, p_reason, p_expiry_date)
    ...
    PERFORM log_permission_change(
        p_granted_by, 'grant', NULL, p_user_id, NULL, p_reason, TRUE, NULL
    );

    RETURN QUERY SELECT true, 'បានផ្តល់សិទ្ធ'::VARCHAR;
END;
$$;


ALTER FUNCTION public.grant_user_permission(p_user_id integer, p_permission_id integer, p_granted_by integer, p_reason text, p_expiry_date date) OWNER TO postgres;

--
-- Name: has_user_permission(integer, character varying, character varying); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.has_user_permission(p_user_id integer, p_resource_code character varying, p_action_code character varying) RETURNS boolean
...
BEGIN
    ...
    WHERE up.user_id = p_user_id
      ...
      AND up.permission_id IN (
          ...
          JOIN permission_resources pr ON pr.id = p.resource_id
          JOIN permission_actions pa ON pa.id = p.action_id
          WHERE pr.resource_code = p_resource_code
            AND pa.action_code = p_action_code
      );
    ...
    RETURN v_has_permission > 0;
END;
$$;


ALTER FUNCTION public.has_user_permission(p_user_id integer, p_resource_code character varying, p_action_code character varying) OWNER TO postgres;

--
-- Name: log_permission_change(integer, character varying, integer, integer, character varying, text, boolean, character varying); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.log_permission_change(p_user_id integer, p_action_type character varying, p_resource_id integer DEFAULT NULL::integer, p_target_user_id integer DEFAULT NULL::integer, p_target_role character varying DEFAULT NULL::character varying, p_reason text DEFAULT NULL::text, p_is_success boolean DEFAULT true, p_ip_address character varying DEFAULT NULL::character varying) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
    INSERT INTO permission_audit_logs 
        (user_id, action_type, resource_id, target_user_id, target_role, reason, is_success, ip_address)
    VALUES 
        (p_user_id, p_action_type, p_resource_id, p_target_user_id, p_target_role, p_reason, p_is_success, p_ip_address);
END;
$$;


ALTER FUNCTION public.log_permission_change(p_user_id integer, p_action_type character varying, p_resource_id integer, p_target_user_id integer, p_target_role character varying, p_reason text, p_is_success boolean, p_ip_address character varying) OWNER TO postgres;

--
-- Name: record_attendance(integer, integer, character varying, date, character varying, integer, integer, integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.record_attendance(p_student_id integer, p_classroom_id integer, p_session character varying, p_attendance_date date, p_status character varying, p_subject_id integer DEFAULT NULL::integer, p_recorded_by_teacher_id integer DEFAULT NULL::integer, p_recorded_by_monitor_id integer DEFAULT NULL::integer) RETURNS TABLE(success boolean, message character varying)
    LANGUAGE plpgsql
    AS $$
DECLARE
...
BEGIN
    ...
    IF v_academic_year_id IS NULL THEN
        RETURN QUERY SELECT false, 'មិនមានឆ្នាំសិក្សាសកម្មនេះឡើយ'::VARCHAR;
        RETURN;
    END IF;

    -- Insert or update attendance
    INSERT INTO attendance 
        (student_id, classroom_id, session, attendance_date, status, 
         subject_id, academic_year_id, recorded_by_teacher_id, recorded_by_monitor_id)
    VALUES 
        (p_student_id, p_classroom_id, p_session, p_attendance_date, p_status,
         p_subject_id, v_academic_year_id, p_recorded_by_teacher_id, p_recorded_by_monitor_id)
    ON CONFLICT (student_id, attendance_date, session) 
    DO UPDATE SET 
        status = p_status,
        subject_id = p_subject_id,
        recorded_by_teacher_id = p_recorded_by_teacher_id,
        recorded_by_monitor_id = p_recorded_by_monitor_id;

    RETURN QUERY SELECT true, 'បានរក្សាទុកវត្តមាន'::VARCHAR;
END;
$$;


ALTER FUNCTION public.record_attendance(p_student_id integer, p_classroom_id integer, p_session character varying, p_attendance_date date, p_status character varying, p_subject_id integer, p_recorded_by_teacher_id integer, p_recorded_by_monitor_id integer) OWNER TO postgres;

--
-- Name: record_score(integer, integer, integer, numeric, numeric, numeric); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.record_score(p_student_id integer, p_subject_id integer, p_period_id integer, p_homework_score numeric, p_exercise_score numeric, p_exam_score numeric DEFAULT 0) RETURNS TABLE(success boolean, message character varying, final_score numeric)
    LANGUAGE plpgsql
    AS $$
DECLARE
    v_attendance_score NUMERIC;
    v_total_activity NUMERIC;
    v_final_score NUMERIC;
    v_final_scores_id INT;
BEGIN
    -- Calculate attendance score (from attendance table for this period)
    SELECT COALESCE(SUM(
        CASE 
            ...
            ELSE 0
        END
    ), 0) INTO v_attendance_score
    FROM attendance
    WHERE student_id = p_student_id
      AND subject_id = p_subject_id
      AND academic_year_id = (
          SELECT academic_year_id FROM academic_periods WHERE id = p_period_id
      );

    -- Ensure scores are not negative
    v_attendance_score := GREATEST(v_attendance_score, 0);

    -- Calculate total activity
    v_total_activity := v_attendance_score + p_homework_score + p_exercise_score;

    -- Calculate final score
    v_final_score := v_total_activity + p_exam_score;

    -- Insert or update final_scores
    INSERT INTO final_scores 
        (student_id, subject_id, period_id, attendance_score, homework_score, exercise_score, exam_score)
    VALUES 
        (p_student_id, p_subject_id, p_period_id, v_attendance_score, p_homework_score, p_exercise_score, p_exam_score)
    ON CONFLICT (student_id, subject_id, period_id) 
    DO UPDATE SET 
        attendance_score = v_attendance_score,
        homework_score = p_homework_score,
        exercise_score = p_exercise_score,
        exam_score = p_exam_score
    RETURNING id INTO v_final_scores_id;

    RETURN QUERY SELECT true, 'បានរក្សាទុកពិន្ទុ'::VARCHAR, v_final_score;
END;
$$;


ALTER FUNCTION public.record_score(p_student_id integer, p_subject_id integer, p_period_id integer, p_homework_score numeric, p_exercise_score numeric, p_exam_score numeric) OWNER TO postgres;

--
-- Name: record_student_payment(integer, integer, numeric, date); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.record_student_payment(p_student_id integer, p_academic_year_id integer, p_amount_paid numeric, p_payment_date date DEFAULT CURRENT_DATE) RETURNS TABLE(success boolean, message character varying, balance numeric)
    LANGUAGE plpgsql
    AS $$
DECLARE
...
BEGIN
    ...
    SELECT amount_paid, amount_due INTO v_current_paid, v_amount_due
    FROM student_pay_year
    WHERE student_id = p_student_id
      AND academic_year_id = p_academic_year_id;

    IF v_amount_due IS NULL THEN
        -- Create new record if doesn't exist
        INSERT INTO student_pay_year 
            (student_id, academic_year_id, amount_paid, payment_date, status)
        VALUES 
            (p_student_id, p_academic_year_id, p_amount_paid, p_payment_date, 'partial');
        
        v_new_balance := 150000 - p_amount_paid;
    ELSE
        -- Update existing record
        v_new_balance := v_amount_due - (v_current_paid + p_amount_paid);
        ...
        UPDATE student_pay_year
        SET amount_paid = v_current_paid + p_amount_paid,
    ...
    RETURN QUERY SELECT true, 'បានកត់ត្រាការបង់ប្រាក់'::VARCHAR, GREATEST(v_new_balance, 0);
END;
$$;


ALTER FUNCTION public.record_student_payment(p_student_id integer, p_academic_year_id integer, p_amount_paid numeric, p_payment_date date) OWNER TO postgres;

--
-- Name: revoke_user_permission(integer, integer, integer, text); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.revoke_user_permission(p_user_id integer, p_permission_id integer, p_revoked_by integer, p_reason text DEFAULT NULL::text) RETURNS TABLE(success boolean, message character varying)
    LANGUAGE plpgsql
    AS $$
BEGIN
    ...
    -- Log the change
    PERFORM log_permission_change(
        p_revoked_by, 'revoke', NULL, p_user_id, NULL, p_reason, TRUE, NULL
    );

    RETURN QUERY SELECT true, 'បានលុបសិទ្ធ'::VARCHAR;
END;
$$;


ALTER FUNCTION public.revoke_user_permission(p_user_id integer, p_permission_id integer, p_revoked_by integer, p_reason text) OWNER TO postgres;

--
-- Name: set_subject_pay_rate(integer, numeric, character varying); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.set_subject_pay_rate(p_subject_id integer, p_rate_per_hour numeric, p_currency character varying DEFAULT 'KHR'::character varying) RETURNS TABLE(success boolean, message character varying)
    LANGUAGE plpgsql
    AS $$
BEGIN
    INSERT INTO pay_rates 
        (subject_id, rate_per_hour, currency, effective_from)
    VALUES 
        (p_subject_id, p_rate_per_hour, p_currency, CURRENT_DATE)
    ON CONFLICT (subject_id)
    DO UPDATE SET rate_per_hour = p_rate_per_hour;

    RETURN QUERY SELECT true, 'បានកំណត់អត្រាប្រាក់'::VARCHAR;
END;
$$;


ALTER FUNCTION public.set_subject_pay_rate(p_subject_id integer, p_rate_per_hour numeric, p_currency character varying) OWNER TO postgres;
...
--
-- Name: unenroll_student(integer, integer, integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.unenroll_student(p_student_id integer, p_classroom_id integer, p_academic_year_id integer) RETURNS TABLE(success boolean, message character varying)
    LANGUAGE plpgsql
    AS $$
DECLARE
    v_rows_deleted INT;
BEGIN
    ...
    IF v_rows_deleted > 0 THEN
        RETURN QUERY SELECT true, 'បានលុបចេញបានជោគជ័យ'::VARCHAR;
    ELSE
        RETURN QUERY SELECT false, 'មិនរកឃើញការចុះឈ្មោះ'::VARCHAR;
    END IF;
END;
$$;


ALTER FUNCTION public.unenroll_student(p_student_id integer, p_classroom_id integer, p_academic_year_id integer) OWNER TO postgres;

--
-- Name: update_class_attendance(integer, character varying, date, character varying, integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.update_class_attendance(p_classroom_id integer, p_session character varying, p_attendance_date date, p_status character varying, p_recorded_by integer) RETURNS TABLE(success boolean, message character varying, records_updated integer)
    LANGUAGE plpgsql
    AS $$
DECLARE
    v_updated_count INT;
...
BEGIN
    ...
    IF v_academic_year_id IS NULL THEN
        RETURN QUERY SELECT false, 'មិនមានឆ្នាំសិក្សាសកម្ម'::VARCHAR, 0;
        RETURN;
    END IF;

    -- Update attendance for all students in class
    UPDATE attendance
    SET status = p_status,
        recorded_by_teacher_id = p_recorded_by
    WHERE student_id IN (
    ...
    RETURN QUERY SELECT true, 'បានធ្វើបច្ចុប្បន្នភាព'::VARCHAR, v_updated_count;
END;
$$;


ALTER FUNCTION public.update_class_attendance(p_classroom_id integer, p_session character varying, p_attendance_date date, p_status character varying, p_recorded_by integer) OWNER TO postgres;
...
CREATE TABLE public.attendance (
    ...
    recorded_by_monitor_id integer,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    late_time time without time zone,
    CONSTRAINT attendance_session_check CHECK (((session)::text = ANY ((ARRAY['morning'::character varying, 'afternoon'::character varying])::text[]))),
    CONSTRAINT attendance_status_check CHECK (((status)::text = ANY (ARRAY[('present'::character varying)::text, ('absent'::character varying)::text, ('permission'::character varying)::text, ('late'::character varying)::text, ('dropout'::character varying)::text]))),
    CONSTRAINT chk_recorded_by CHECK ((num_nonnulls(recorded_by_teacher_id, recorded_by_monitor_id) <= 1))
);
...
--
-- Name: attendance_warnings; Type: TABLE; Schema: public; Owner: admin
--

CREATE TABLE public.attendance_warnings (
    id bigint NOT NULL,
    last_absent_warned integer NOT NULL,
    last_permission_warned integer NOT NULL,
    last_late_warned integer NOT NULL,
...
ALTER TABLE public.attendance_warnings OWNER TO admin;

--
-- Name: attendance_warnings_id_seq; Type: SEQUENCE; Schema: public; Owner: admin
--

ALTER TABLE public.attendance_warnings ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.attendance_warnings_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.awards (
    ...
    award_type character varying(30) DEFAULT 'academic'::character varying NOT NULL,
    ...
    awarded_by integer,
    status character varying(20) DEFAULT 'awarded'::character varying,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT awards_award_type_check CHECK (((award_type)::text = ANY ((ARRAY['academic'::character varying, 'behavioral'::character varying, 'leadership'::character varying, 'sports'::character varying, 'arts'::character varying, 'attendance'::character varying, 'other'::character varying])::text[]))),
    CONSTRAINT awards_status_check CHECK (((status)::text = ANY ((ARRAY['pending'::character varying, 'awarded'::character varying, 'rejected'::character varying, 'cancelled'::character varying])::text[])))
);
...
--
-- Name: class_monitors; Type: TABLE; Schema: public; Owner: postgres
--
...
CREATE TABLE public.class_monitors (
    ...
    classroom_id integer NOT NULL,
    academic_year_id integer NOT NULL,
    role character varying(30) DEFAULT 'monitor'::character varying NOT NULL,
    appointed_date date,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT class_monitors_role_check CHECK (((role)::text = ANY ((ARRAY['monitor'::character varying, 'deputy'::character varying])::text[])))
);


ALTER TABLE public.class_monitors OWNER TO postgres;

--
-- Name: class_monitors_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER SEQUENCE public.class_monitors_id_seq OWNER TO postgres;

--
-- Name: class_monitors_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
CREATE TABLE public.classrooms (
    ...
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    desks_per_row smallint NOT NULL
);
...
CREATE TABLE public.communes (
    commune_code character varying(8) NOT NULL,
    name_kh character varying(100),
    name_en character varying(100),
    district_id character varying(8)
);
...
CREATE TABLE public.districts (
    ...
    name_kh character varying(100),
    name_en character varying(100),
    province_id character varying(8)
);
...
CREATE TABLE public.documents (
    ...
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT documents_doc_category_check CHECK (((doc_category)::text = ANY ((ARRAY['internal'::character varying, 'inspectorate'::character varying])::text[])))
);
...
--
-- Name: dropout; Type: TABLE; Schema: public; Owner: admin
--
...
ALTER TABLE public.dropout OWNER TO admin;

--
-- Name: dropout_id_seq; Type: SEQUENCE; Schema: public; Owner: admin
--

ALTER TABLE public.dropout ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.dropout_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: education_levels; Type: TABLE; Schema: public; Owner: admin
--
...
ALTER TABLE public.education_levels OWNER TO admin;

--
-- Name: education_levels_id_seq; Type: SEQUENCE; Schema: public; Owner: admin
--
...
--
-- Name: final_scores; Type: TABLE; Schema: public; Owner: postgres
--
...
CREATE TABLE public.final_scores (
    ...
    attendance_score numeric(5,2) DEFAULT 0 NOT NULL,
    homework_score numeric(5,2) DEFAULT 0 NOT NULL,
    exercise_score numeric(5,2) DEFAULT 0 NOT NULL,
    exam_score numeric(6,2) DEFAULT 0 NOT NULL,
    total_activity numeric(6,2) GENERATED ALWAYS AS (((attendance_score + homework_score) + exercise_score)) STORED,
    final_score numeric(6,2) GENERATED ALWAYS AS ((((attendance_score + homework_score) + exercise_score) + exam_score)) STORED,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT final_scores_check CHECK (((attendance_score >= (0)::numeric) AND (homework_score >= (0)::numeric) AND (exercise_score >= (0)::numeric) AND (exam_score >= (0)::numeric)))
);
...
--
-- Name: final_scores_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.final_scores_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.final_scores_id_seq OWNER TO postgres;

--
-- Name: final_scores_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.final_scores_id_seq OWNED BY public.final_scores.id;


--
-- Name: kutis; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.kutis (
    id integer NOT NULL,
    pagoda_id integer NOT NULL,
    kuti_name character varying(30) NOT NULL,
    manager_name character varying(150) NOT NULL,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP
);


ALTER TABLE public.kutis OWNER TO postgres;

--
-- Name: kutis_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.kutis_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.kutis_id_seq OWNER TO postgres;

--
-- Name: kutis_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.kutis_id_seq OWNED BY public.kutis.id;


--
-- Name: monk_permission; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.monk_permission (
    id integer NOT NULL,
    ...
    reviewed_by integer,
    reviewed_by_monitor integer,
    reviewed_at timestamp without time zone,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT monk_permission_check CHECK ((end_date >= start_date)),
    CONSTRAINT monk_permission_status_check CHECK (((status)::text = ANY ((ARRAY['pending'::character varying, 'approved'::character varying, 'rejected'::character varying, 'cancelled'::character varying])::text[])))
);


ALTER TABLE public.monk_permission OWNER TO postgres;

--
-- Name: monk_permission_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.monk_permission_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.monk_permission_id_seq OWNER TO postgres;

--
-- Name: monk_permission_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.monk_permission_id_seq OWNED BY public.monk_permission.id;


--
-- Name: monk_permission_logs; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.monk_permission_logs (
    id integer NOT NULL,
    permission_id integer NOT NULL,
    ...
    performed_by_monitor integer,
    note character varying(255),
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP
);


ALTER TABLE public.monk_permission_logs OWNER TO postgres;

--
-- Name: monk_permission_logs_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.monk_permission_logs_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.monk_permission_logs_id_seq OWNER TO postgres;

--
-- Name: monk_permission_logs_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.monk_permission_logs_id_seq OWNED BY public.monk_permission_logs.id;
...
CREATE TABLE public.monthly_payrolls (
    ...
    total_teaching numeric(5,2) NOT NULL,
    rate_per_hour numeric(10,2) NOT NULL,
    total_amount numeric(12,2) GENERATED ALWAYS AS ((total_teaching * rate_per_hour)) STORED,
...
ALTER SEQUENCE public.monthly_payrolls_id_seq OWNER TO postgres;
...
--
-- Name: multiple_permission; Type: TABLE; Schema: public; Owner: admin
--

CREATE TABLE public.multiple_permission (
    id bigint NOT NULL,
    reason text,
    start_date date NOT NULL,
    end_date date NOT NULL,
...
ALTER TABLE public.multiple_permission OWNER TO admin;

--
-- Name: multiple_permission_id_seq; Type: SEQUENCE; Schema: public; Owner: admin
--

ALTER TABLE public.multiple_permission ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.multiple_permission_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: pagodas; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.pagodas (
    id integer NOT NULL,
    name character varying(150) NOT NULL,
    abbot_name character varying(150) NOT NULL,
    village_id character varying(8),
    commune_id character varying(8),
    district_id character varying(8),
    province_id character varying(8),
...
ALTER TABLE public.pagodas OWNER TO postgres;

--
-- Name: pagodas_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.pagodas_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.pagodas_id_seq OWNER TO postgres;

--
-- Name: pagodas_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.pagodas_id_seq OWNED BY public.pagodas.id;


--
-- Name: paper_headers; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.paper_headers (
    id integer NOT NULL,
    name character varying(100) NOT NULL,
...
ALTER TABLE public.paper_headers OWNER TO postgres;

--
-- Name: paper_headers_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.paper_headers_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.paper_headers_id_seq OWNER TO postgres;

--
-- Name: paper_headers_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.paper_headers_id_seq OWNED BY public.paper_headers.id;
...
CREATE TABLE public.pay_rates (
    ...
    subject_id integer,
    rate_per_hour numeric(10,2) NOT NULL,
    currency character varying(10) DEFAULT 'KHR'::character varying NOT NULL,
...
--
-- Name: payroll_rates; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.payroll_rates OWNER TO postgres;

--
-- Name: payroll_rates_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER SEQUENCE public.payroll_rates_id_seq OWNER TO postgres;

--
-- Name: payroll_rates_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: pending_students; Type: TABLE; Schema: public; Owner: postgres
--
...
CREATE TABLE public.pending_students (
    ...
    reviewed_at timestamp without time zone,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    birth_pagoda_id bigint,
    birth_village_code character varying(8),
    chaya_name character varying(100),
    chaya_no character varying(50),
    current_pagoda_id bigint,
    education_level character varying(50),
    kuti_id bigint,
    latin_name character varying(100),
    monk_status character varying(20),
    nationality_id bigint,
    ordination_date date,
    preceptor_name character varying(150),
    sanghatika_no character varying(50),
    tracking_code character varying(6),
    image_url character varying(500),
    new_birth_pagoda_name character varying(150),
    new_current_pagoda_name character varying(150),
    new_kuti_name character varying(150),
    new_nationality_name character varying(150)
);


ALTER TABLE public.pending_students OWNER TO postgres;

--
-- Name: pending_students_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.pending_students_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.pending_students_id_seq OWNER TO postgres;

--
-- Name: pending_students_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.pending_students_id_seq OWNED BY public.pending_students.id;


--
-- Name: pending_teachers; Type: TABLE; Schema: public; Owner: admin
--

CREATE TABLE public.pending_teachers (
    id bigint NOT NULL,
    tracking_code character varying(6),
    image_url character varying(500),
    first_name character varying(50) NOT NULL,
...
ALTER TABLE public.pending_teachers OWNER TO admin;

--
-- Name: pending_teachers_id_seq; Type: SEQUENCE; Schema: public; Owner: admin
--

ALTER TABLE public.pending_teachers ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.pending_teachers_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: permission_actions; Type: TABLE; Schema: public; Owner: postgres
--
...
CREATE TABLE public.permission_actions (
    ...
    description text,
    action_level smallint DEFAULT 1,
...
--
-- Name: permission_actions_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.permission_actions_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.permission_actions_id_seq OWNER TO postgres;

--
-- Name: permission_actions_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.permission_actions_id_seq OWNED BY public.permission_actions.id;
...
CREATE TABLE public.permission_audit_logs (
    ...
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT permission_audit_logs_action_type_check CHECK (((action_type)::text = ANY ((ARRAY['grant'::character varying, 'deny'::character varying, 'revoke'::character varying, 'modify'::character varying, 'create_resource'::character varying, 'create_action'::character varying])::text[])))
);
...
--
-- Name: permission_group_members; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.permission_group_members OWNER TO postgres;

--
-- Name: permission_group_members_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.permission_group_members_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.permission_group_members_id_seq OWNER TO postgres;

--
-- Name: permission_group_members_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.permission_group_members_id_seq OWNED BY public.permission_group_members.id;
...
CREATE TABLE public.permission_groups (
    ...
    description text,
    group_type character varying(30) DEFAULT 'module'::character varying,
    icon character varying(50),
    display_order smallint,
    is_active boolean DEFAULT true,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT permission_groups_group_type_check CHECK (((group_type)::text = ANY ((ARRAY['module'::character varying, 'department'::character varying, 'feature'::character varying, 'custom'::character varying])::text[])))
);
...
--
-- Name: permission_resources; Type: TABLE; Schema: public; Owner: postgres
--
...
CREATE TABLE public.permission_resources (
    ...
    description text,
    resource_type character varying(30) DEFAULT 'module'::character varying,
    icon character varying(50),
    display_order smallint,
    is_active boolean DEFAULT true,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT permission_resources_resource_type_check CHECK (((resource_type)::text = ANY ((ARRAY['module'::character varying, 'feature'::character varying, 'report'::character varying, 'setting'::character varying, 'admin'::character varying])::text[])))
);


ALTER TABLE public.permission_resources OWNER TO postgres;

--
-- Name: permission_resources_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.permission_resources_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.permission_resources_id_seq OWNER TO postgres;

--
-- Name: permission_resources_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.permission_resources_id_seq OWNED BY public.permission_resources.id;
...
CREATE TABLE public.permissions (
    ...
    permission_name character varying(150),
    description text,
    is_active boolean DEFAULT true,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP
...
--
-- Name: registration_sessions; Type: TABLE; Schema: public; Owner: admin
--
...
ALTER TABLE public.registration_sessions OWNER TO admin;

--
-- Name: registration_sessions_id_seq; Type: SEQUENCE; Schema: public; Owner: admin
--

ALTER TABLE public.registration_sessions ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.registration_sessions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: report_daily; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.report_daily (
    id integer NOT NULL,
...
ALTER TABLE public.report_daily OWNER TO postgres;

--
-- Name: report_daily_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.report_daily_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.report_daily_id_seq OWNER TO postgres;

--
-- Name: report_daily_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.report_daily_id_seq OWNED BY public.report_daily.id;


--
-- Name: resource_access_policies; Type: TABLE; Schema: public; Owner: postgres
--
...
CREATE TABLE public.resource_access_policies (
    ...
    policy_type character varying(30) DEFAULT 'role_based'::character varying,
    default_access character varying(20) DEFAULT 'deny'::character varying,
    require_approval boolean DEFAULT false,
    approval_role character varying(30) DEFAULT 'director'::character varying,
    is_active boolean DEFAULT true,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT resource_access_policies_default_access_check CHECK (((default_access)::text = ANY ((ARRAY['grant'::character varying, 'deny'::character varying])::text[]))),
    CONSTRAINT resource_access_policies_policy_type_check CHECK (((policy_type)::text = ANY ((ARRAY['role_based'::character varying, 'user_based'::character varying, 'group_based'::character varying, 'public'::character varying, 'restricted'::character varying])::text[])))
);


ALTER TABLE public.resource_access_policies OWNER TO postgres;

--
-- Name: resource_access_policies_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.resource_access_policies_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.resource_access_policies_id_seq OWNER TO postgres;

--
-- Name: resource_access_policies_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.resource_access_policies_id_seq OWNED BY public.resource_access_policies.id;
...
CREATE TABLE public.role_permissions (
    ...
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT role_permissions_role_check CHECK (((role)::text = ANY ((ARRAY['director'::character varying, 'teacher'::character varying, 'monitor'::character varying, 'admin'::character varying, 'guest'::character varying])::text[])))
);
...
--
-- Name: schedule_substitutions; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.schedule_substitutions (
    id integer NOT NULL,
    classroom_id integer NOT NULL,
    change_date date NOT NULL,
    time_slot_id integer NOT NULL,
    original_subject_id integer NOT NULL,
...
ALTER TABLE public.schedule_substitutions OWNER TO postgres;

--
-- Name: schedule_substitutions_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.schedule_substitutions_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.schedule_substitutions_id_seq OWNER TO postgres;

--
-- Name: schedule_substitutions_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.schedule_substitutions_id_seq OWNED BY public.schedule_substitutions.id;
...
CREATE TABLE public.school_calendar (
    ...
    color_code character varying(7) DEFAULT '#2196F3'::character varying,
    notify_days smallint DEFAULT 0,
    is_public boolean DEFAULT true,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT school_calendar_check CHECK (((end_date IS NULL) OR (end_date >= start_date))),
    CONSTRAINT school_calendar_event_type_check CHECK (((event_type)::text = ANY ((ARRAY['holiday'::character varying, 'exam'::character varying, 'event'::character varying, 'meeting'::character varying, 'deadline'::character varying, 'other'::character varying])::text[]))),
    CONSTRAINT school_calendar_recurring_type_check CHECK (((recurring_type)::text = ANY ((ARRAY['yearly'::character varying, 'monthly'::character varying, 'weekly'::character varying, 'daily'::character varying, NULL::character varying])::text[])))
);
...
--
-- Name: school_calendar_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.school_calendar_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.school_calendar_id_seq OWNER TO postgres;

--
-- Name: school_calendar_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.school_calendar_id_seq OWNED BY public.school_calendar.id;
...
CREATE TABLE public.scores (
    ...
    exam_date date,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT scores_raw_score_check CHECK ((raw_score >= (0)::numeric)),
    CONSTRAINT scores_score_type_check CHECK (((score_type)::text = ANY ((ARRAY['monthly'::character varying, 'semester_exam'::character varying])::text[])))
);
...
ALTER SEQUENCE public.staff_positions_id_seq OWNER TO postgres;
...
--
-- Name: student_education_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.student_education_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.student_education_id_seq OWNER TO postgres;

--
-- Name: student_education_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.student_education_id_seq OWNED BY public.student_education.id;


--
-- Name: student_pay_year; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.student_pay_year (
    id integer NOT NULL,
    student_id integer NOT NULL,
    academic_year_id integer NOT NULL,
    amount_due numeric(10,2) DEFAULT 150000.00 NOT NULL,
    ...
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT student_pay_year_status_check CHECK (((status)::text = ANY ((ARRAY['pending'::character varying, 'partial'::character varying, 'paid'::character varying])::text[])))
);


ALTER TABLE public.student_pay_year OWNER TO postgres;

--
-- Name: student_pay_year_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.student_pay_year_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.student_pay_year_id_seq OWNER TO postgres;

--
-- Name: student_pay_year_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.student_pay_year_id_seq OWNED BY public.student_pay_year.id;
...
CREATE TABLE public.students (
    ...
    monk_status character varying(20) DEFAULT 'សាមណេរ'::character varying NOT NULL,
    image_url character varying(500),
    sanghatika_no character varying(50),
    chaya_name character varying(100),
    chaya_no character varying(50),
    ...
    phone character varying(20),
    current_pagoda_id integer,
    birth_pagoda_id integer,
    kuti_id integer,
    enrollment_date date,
    status character varying(20) DEFAULT 'active'::character varying NOT NULL,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT chk_student_status_gender CHECK ((((monk_status)::text <> ALL ((ARRAY['ភិក្ខុ'::character varying, 'សាមណេរ'::character varying])::text[])) OR ((gender)::text = 'ប្រុស'::text))),
    CONSTRAINT students_monk_status_check CHECK (((monk_status)::text = ANY ((ARRAY['ភិក្ខុ'::character varying, 'សាមណេរ'::character varying, 'គ្រហស្ថ'::character varying])::text[]))),
    CONSTRAINT students_status_check CHECK (((status)::text = ANY ((ARRAY['active'::character varying, 'inactive'::character varying, 'graduated'::character varying, 'dropped'::character varying])::text[])))
);
...
CREATE TABLE public.subjects (
    ...
    total_homework integer DEFAULT 4,
    total_time_exam integer,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP
);
...
--
-- Name: teacher_education; Type: TABLE; Schema: public; Owner: postgres
--
...
CREATE TABLE public.teacher_education (
    ...
    institution character varying(150),
    education_type character varying(20),
    start_year smallint,
    end_year smallint,
    is_completed boolean DEFAULT true,
    note character varying(255),
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT teacher_education_education_type_check CHECK (((education_type)::text = ANY ((ARRAY['secular'::character varying, 'buddhist'::character varying])::text[])))
);


ALTER TABLE public.teacher_education OWNER TO postgres;

--
-- Name: teacher_education_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.teacher_education_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.teacher_education_id_seq OWNER TO postgres;

--
-- Name: teacher_education_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.teacher_education_id_seq OWNED BY public.teacher_education.id;


--
-- Name: teacher_registration_sessions; Type: TABLE; Schema: public; Owner: admin
--

CREATE TABLE public.teacher_registration_sessions (
    id bigint NOT NULL,
    title character varying(200) NOT NULL,
    start_date date NOT NULL,
    end_date date NOT NULL,
...
ALTER TABLE public.teacher_registration_sessions OWNER TO admin;

--
-- Name: teacher_registration_sessions_id_seq; Type: SEQUENCE; Schema: public; Owner: admin
--

ALTER TABLE public.teacher_registration_sessions ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.teacher_registration_sessions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.teacher_salaries (
    ...
    rate_per_hour numeric(10,2) NOT NULL,
    total_amount numeric(12,2) GENERATED ALWAYS AS ((total_hours * rate_per_hour)) STORED,
...
CREATE TABLE public.teachers (
    ...
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT chk_teacher_status_gender CHECK (((((monk_status)::text <> ALL ((ARRAY['ភិក្ខុ'::character varying, 'សាមណេរ'::character varying])::text[])) OR ((gender)::text = 'ប្រុស'::text)) AND (((monk_status)::text <> 'ដូនជី'::text) OR ((gender)::text = 'ស្រី'::text)))),
    CONSTRAINT teachers_gender_check CHECK (((gender)::text = ANY ((ARRAY['ប្រុស'::character varying, 'ស្រី'::character varying])::text[]))),
    CONSTRAINT teachers_monk_status_check CHECK (((monk_status)::text = ANY ((ARRAY['ភិក្ខុ'::character varying, 'សាមណេរ'::character varying, 'ដូនជី'::character varying, 'គ្រហស្ថ'::character varying])::text[]))),
...
--
-- Name: teaching_sessions; Type: TABLE; Schema: public; Owner: postgres
--
...
CREATE TABLE public.teaching_sessions (
    ...
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT chk_sub_link CHECK ((((is_substitute = false) AND (substitution_id IS NULL)) OR ((is_substitute = true) AND (substitution_id IS NOT NULL))))
);
...
--
-- Name: teaching_sessions_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.teaching_sessions_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.teaching_sessions_id_seq OWNER TO postgres;

--
-- Name: teaching_sessions_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.teaching_sessions_id_seq OWNED BY public.teaching_sessions.id;
...
CREATE TABLE public.time_slots (
    ...
    CONSTRAINT time_slots_session_check CHECK (((session)::text = ANY ((ARRAY['morning'::character varying, 'afternoon'::character varying])::text[])))
);
...
CREATE TABLE public.user_permissions (
    ...
    user_id integer NOT NULL,
    permission_id integer NOT NULL,
    grant_type character varying(20) DEFAULT 'grant'::character varying,
    reason text,
    granted_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    granted_by integer,
    expiry_date date,
...
CREATE TABLE public.users (
    ...
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT users_check CHECK ((num_nonnulls(teacher_id, student_id) <= 1)),
    CONSTRAINT users_role_check CHECK (((role)::text = ANY ((ARRAY['director'::character varying, 'teacher'::character varying, 'monitor'::character varying, 'admin'::character varying, 'guest'::character varying])::text[])))
);
...
--
-- Name: v_permission_audit_report; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.v_permission_audit_report AS
 SELECT pal.id,
    pal.created_at,
   ...
   FROM ((((public.permission_audit_logs pal
     ...
     LEFT JOIN public.permission_resources pr ON ((pr.id = pal.resource_id)))
     LEFT JOIN public.permission_actions pa ON ((pa.id = pal.action_id)))
     LEFT JOIN public.users tu ON ((tu.id = pal.target_user_id)))
  ORDER BY pal.created_at DESC;


ALTER VIEW public.v_permission_audit_report OWNER TO postgres;

--
-- Name: v_resource_access_summary; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.v_resource_access_summary AS
 SELECT pr.resource_code,
    pr.resource_name,
    rap.policy_type,
    rap.default_access,
    rap.require_approval,
    rap.approval_role,
    count(DISTINCT p.id) AS total_actions,
    count(DISTINCT rp.role) AS roles_with_access,
    count(DISTINCT up.user_id) AS users_with_custom_access
   FROM ((((public.permission_resources pr
     LEFT JOIN public.resource_access_policies rap ON ((rap.resource_id = pr.id)))
     LEFT JOIN public.permissions p ON ((p.resource_id = pr.id)))
  ...
  GROUP BY pr.id, pr.resource_code, pr.resource_name, rap.policy_type, rap.default_access, rap.require_approval, rap.approval_role;


ALTER VIEW public.v_resource_access_summary OWNER TO postgres;

--
-- Name: v_role_permission_matrix; Type: VIEW; Schema: public; Owner: postgres
--
...
CREATE VIEW public.v_role_permission_matrix AS
 SELECT rp.role,
   ...
   FROM ((((public.role_permissions rp
     ...
     JOIN public.permission_resources pr ON ((pr.id = p.resource_id)))
     JOIN public.permission_actions pa ON ((pa.id = p.action_id)))
     LEFT JOIN public.users u ON ((u.id = rp.granted_by)))
  ORDER BY rp.role, pr.resource_name, pa.action_name;


ALTER VIEW public.v_role_permission_matrix OWNER TO postgres;

--
-- Name: v_user_permissions_summary; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.v_user_permissions_summary AS
 SELECT u.id AS user_id,
    ...
    up.expiry_date,
        CASE
            WHEN ((up.expiry_date IS NOT NULL) AND (up.expiry_date < CURRENT_DATE)) THEN 'expired'::text
            WHEN (up.is_active = false) THEN 'inactive'::text
            ELSE 'active'::text
        END AS permission_status
   FROM ((((public.users u
     LEFT JOIN public.user_permissions up ON ((up.user_id = u.id)))
     LEFT JOIN public.permissions p ON ((p.id = up.permission_id)))
     LEFT JOIN public.permission_resources pr ON ((pr.id = p.resource_id)))
     LEFT JOIN public.permission_actions pa ON ((pa.id = p.action_id)))
  ORDER BY u.username, pr.resource_name, pa.action_name;


ALTER VIEW public.v_user_permissions_summary OWNER TO postgres;

--
-- Name: view_subject_max_scores; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.view_subject_max_scores AS
 SELECT id AS subject_id,
    subject_name,
    total_score AS full_100_percent,
    ((total_score)::numeric * 0.20) AS max_attendance,
    ((total_score)::numeric * 0.20) AS max_homework,
    ((total_score)::numeric * 0.20) AS max_exercise,
    ((total_score)::numeric * 0.60) AS max_activity,
    ((total_score)::numeric * 0.40) AS max_exam
   FROM public.subjects;


ALTER VIEW public.view_subject_max_scores OWNER TO postgres;
...
CREATE TABLE public.villages (
    village_code character varying(8) NOT NULL,
    name_kh character varying(100),
    name_en character varying(100),
    commune_id character varying(8)
);
...
--
-- Name: yearbook_entries; Type: TABLE; Schema: public; Owner: postgres
--
...
CREATE TABLE public.yearbook_entries (
    ...
    academic_year_id integer NOT NULL,
    classroom_id integer,
    entry_type character varying(30) DEFAULT 'student'::character varying NOT NULL,
    title character varying(150) NOT NULL,
    ...
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT yearbook_entries_entry_type_check CHECK (((entry_type)::text = ANY ((ARRAY['director'::character varying, 'deputy'::character varying, 'teacher'::character varying, 'staff'::character varying, 'student'::character varying, 'monk'::character varying, 'other'::character varying])::text[])))
);


ALTER TABLE public.yearbook_entries OWNER TO postgres;

--
-- Name: yearbook_entries_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.yearbook_entries_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.yearbook_entries_id_seq OWNER TO postgres;

--
-- Name: yearbook_entries_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.yearbook_entries_id_seq OWNED BY public.yearbook_entries.id;
...
--
-- Name: class_monitors id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: final_scores id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.final_scores ALTER COLUMN id SET DEFAULT nextval('public.final_scores_id_seq'::regclass);


--
-- Name: kutis id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.kutis ALTER COLUMN id SET DEFAULT nextval('public.kutis_id_seq'::regclass);


--
-- Name: monk_permission id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.monk_permission ALTER COLUMN id SET DEFAULT nextval('public.monk_permission_id_seq'::regclass);


--
-- Name: monk_permission_logs id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.monk_permission_logs ALTER COLUMN id SET DEFAULT nextval('public.monk_permission_logs_id_seq'::regclass);
...
--
-- Name: pagodas id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.pagodas ALTER COLUMN id SET DEFAULT nextval('public.pagodas_id_seq'::regclass);


--
-- Name: paper_headers id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.paper_headers ALTER COLUMN id SET DEFAULT nextval('public.paper_headers_id_seq'::regclass);
...
--
-- Name: payroll_rates id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: pending_students id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.pending_students ALTER COLUMN id SET DEFAULT nextval('public.pending_students_id_seq'::regclass);


--
-- Name: permission_actions id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.permission_actions ALTER COLUMN id SET DEFAULT nextval('public.permission_actions_id_seq'::regclass);
...
--
-- Name: permission_group_members id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.permission_group_members ALTER COLUMN id SET DEFAULT nextval('public.permission_group_members_id_seq'::regclass);
...
--
-- Name: permission_resources id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.permission_resources ALTER COLUMN id SET DEFAULT nextval('public.permission_resources_id_seq'::regclass);
...
--
-- Name: report_daily id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.report_daily ALTER COLUMN id SET DEFAULT nextval('public.report_daily_id_seq'::regclass);


--
-- Name: resource_access_policies id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.resource_access_policies ALTER COLUMN id SET DEFAULT nextval('public.resource_access_policies_id_seq'::regclass);
...
--
-- Name: schedule_substitutions id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.schedule_substitutions ALTER COLUMN id SET DEFAULT nextval('public.schedule_substitutions_id_seq'::regclass);


--
-- Name: school_calendar id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.school_calendar ALTER COLUMN id SET DEFAULT nextval('public.school_calendar_id_seq'::regclass);
...
--
-- Name: student_education id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.student_education ALTER COLUMN id SET DEFAULT nextval('public.student_education_id_seq'::regclass);


--
-- Name: student_pay_year id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.student_pay_year ALTER COLUMN id SET DEFAULT nextval('public.student_pay_year_id_seq'::regclass);
...
--
-- Name: teacher_education id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.teacher_education ALTER COLUMN id SET DEFAULT nextval('public.teacher_education_id_seq'::regclass);
...
--
-- Name: teaching_sessions id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.teaching_sessions ALTER COLUMN id SET DEFAULT nextval('public.teaching_sessions_id_seq'::regclass);
...
--
-- Name: yearbook_entries id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.yearbook_entries ALTER COLUMN id SET DEFAULT nextval('public.yearbook_entries_id_seq'::regclass);
...
--
-- Name: attendance attendance_student_id_attendance_date_session_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.attendance
    ADD CONSTRAINT attendance_student_id_attendance_date_session_key UNIQUE (student_id, attendance_date, session);


--
-- Name: attendance_warnings attendance_warnings_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--
...
--
-- Name: attendance_warnings attendance_warnings_student_id_academic_year_id_28261527_uniq; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.attendance_warnings
    ADD CONSTRAINT attendance_warnings_student_id_academic_year_id_28261527_uniq UNIQUE (student_id, academic_year_id);
...
--
-- Name: class_monitors class_monitors_classroom_id_academic_year_id_role_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.class_monitors
    ADD CONSTRAINT class_monitors_classroom_id_academic_year_id_role_key UNIQUE (classroom_id, academic_year_id, role);


--
-- Name: class_monitors class_monitors_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: class_subjects class_subjects_classroom_id_subject_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.class_subjects
    ADD CONSTRAINT class_subjects_classroom_id_subject_id_key UNIQUE (classroom_id, subject_id);
...
ALTER TABLE ONLY public.communes
    ADD CONSTRAINT communes_pkey PRIMARY KEY (commune_code);
...
--
-- Name: dropout dropout_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.dropout
    ADD CONSTRAINT dropout_pkey PRIMARY KEY (id);


--
-- Name: education_levels education_levels_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--
...
--
-- Name: enrollments enrollments_student_id_classroom_id_academic_year_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.enrollments
    ADD CONSTRAINT enrollments_student_id_classroom_id_academic_year_id_key UNIQUE (student_id, classroom_id, academic_year_id);


--
-- Name: final_scores final_scores_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: final_scores final_scores_student_id_subject_id_period_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.final_scores
    ADD CONSTRAINT final_scores_student_id_subject_id_period_id_key UNIQUE (student_id, subject_id, period_id);


--
-- Name: kutis kutis_pagoda_id_kuti_name_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.kutis
    ADD CONSTRAINT kutis_pagoda_id_kuti_name_key UNIQUE (pagoda_id, kuti_name);


--
-- Name: kutis kutis_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.kutis
    ADD CONSTRAINT kutis_pkey PRIMARY KEY (id);


--
-- Name: monk_permission_logs monk_permission_logs_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.monk_permission_logs
    ADD CONSTRAINT monk_permission_logs_pkey PRIMARY KEY (id);


--
-- Name: monk_permission monk_permission_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.monk_permission
    ADD CONSTRAINT monk_permission_pkey PRIMARY KEY (id);
...
--
-- Name: monthly_payrolls monthly_payrolls_teacher_id_subject_id_academic_period_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.monthly_payrolls
    ADD CONSTRAINT monthly_payrolls_teacher_id_subject_id_academic_period_id_key UNIQUE (teacher_id, subject_id, academic_period_id);


--
-- Name: multiple_permission multiple_permission_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.multiple_permission
    ADD CONSTRAINT multiple_permission_pkey PRIMARY KEY (id);
...
--
-- Name: pagodas pagodas_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.pagodas
    ADD CONSTRAINT pagodas_pkey PRIMARY KEY (id);


--
-- Name: paper_headers paper_headers_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.paper_headers
    ADD CONSTRAINT paper_headers_pkey PRIMARY KEY (id);
...
--
-- Name: payroll_rates payroll_rates_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: pending_students pending_students_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.pending_students
    ADD CONSTRAINT pending_students_pkey PRIMARY KEY (id);


--
-- Name: pending_students pending_students_tracking_code_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.pending_students
    ADD CONSTRAINT pending_students_tracking_code_key UNIQUE (tracking_code);


--
-- Name: pending_teachers pending_teachers_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.pending_teachers
    ADD CONSTRAINT pending_teachers_pkey PRIMARY KEY (id);


--
-- Name: pending_teachers pending_teachers_tracking_code_key; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.pending_teachers
    ADD CONSTRAINT pending_teachers_tracking_code_key UNIQUE (tracking_code);


--
-- Name: permission_actions permission_actions_action_code_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.permission_actions
    ADD CONSTRAINT permission_actions_action_code_key UNIQUE (action_code);


--
-- Name: permission_actions permission_actions_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: permission_group_members permission_group_members_group_id_permission_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.permission_group_members
    ADD CONSTRAINT permission_group_members_group_id_permission_id_key UNIQUE (group_id, permission_id);


--
-- Name: permission_group_members permission_group_members_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: permission_groups permission_groups_group_code_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.permission_groups
    ADD CONSTRAINT permission_groups_group_code_key UNIQUE (group_code);
...
--
-- Name: permission_resources permission_resources_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: permission_resources permission_resources_resource_code_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.permission_resources
    ADD CONSTRAINT permission_resources_resource_code_key UNIQUE (resource_code);
...
--
-- Name: permissions permissions_resource_id_action_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.permissions
    ADD CONSTRAINT permissions_resource_id_action_id_key UNIQUE (resource_id, action_id);
...
ALTER TABLE ONLY public.provinces
    ADD CONSTRAINT provinces_pkey PRIMARY KEY (province_code);


--
-- Name: registration_sessions registration_sessions_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--
...
--
-- Name: report_daily report_daily_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.report_daily
    ADD CONSTRAINT report_daily_pkey PRIMARY KEY (id);


--
-- Name: report_daily report_daily_report_date_reported_by_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.report_daily
    ADD CONSTRAINT report_daily_report_date_reported_by_key UNIQUE (report_date, reported_by);


--
-- Name: resource_access_policies resource_access_policies_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.resource_access_policies
    ADD CONSTRAINT resource_access_policies_pkey PRIMARY KEY (id);
...
--
-- Name: schedule_substitutions schedule_substitutions_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.schedule_substitutions
    ADD CONSTRAINT schedule_substitutions_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public.school_calendar
    ADD CONSTRAINT school_calendar_pkey PRIMARY KEY (id);
...
--
-- Name: scores scores_student_id_subject_id_period_id_score_type_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.scores
    ADD CONSTRAINT scores_student_id_subject_id_period_id_score_type_key UNIQUE (student_id, subject_id, period_id, score_type);
...
--
-- Name: student_education student_education_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.student_education
    ADD CONSTRAINT student_education_pkey PRIMARY KEY (id);


--
-- Name: student_pay_year student_pay_year_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.student_pay_year
    ADD CONSTRAINT student_pay_year_pkey PRIMARY KEY (id);


--
-- Name: student_pay_year student_pay_year_student_id_academic_year_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.student_pay_year
    ADD CONSTRAINT student_pay_year_student_id_academic_year_id_key UNIQUE (student_id, academic_year_id);
...
--
-- Name: teacher_education teacher_education_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.teacher_education
    ADD CONSTRAINT teacher_education_pkey PRIMARY KEY (id);


--
-- Name: teacher_registration_sessions teacher_registration_sessions_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.teacher_registration_sessions
    ADD CONSTRAINT teacher_registration_sessions_pkey PRIMARY KEY (id);
...
--
-- Name: teacher_salaries teacher_salaries_teacher_id_subject_id_academic_year_id_per_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.teacher_salaries
    ADD CONSTRAINT teacher_salaries_teacher_id_subject_id_academic_year_id_per_key UNIQUE (teacher_id, subject_id, academic_year_id, period_label);
...
--
-- Name: teaching_sessions teaching_sessions_classroom_id_session_date_time_slot_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.teaching_sessions
    ADD CONSTRAINT teaching_sessions_classroom_id_session_date_time_slot_id_key UNIQUE (classroom_id, session_date, time_slot_id);


--
-- Name: teaching_sessions teaching_sessions_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: time_slots time_slots_session_slot_no_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.time_slots
    ADD CONSTRAINT time_slots_session_slot_no_key UNIQUE (session, slot_no);


--
-- Name: timetable timetable_classroom_id_academic_year_id_day_no_time_slot_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.timetable
    ADD CONSTRAINT timetable_classroom_id_academic_year_id_day_no_time_slot_id_key UNIQUE (classroom_id, academic_year_id, day_no, time_slot_id);
...
ALTER TABLE ONLY public.villages
    ADD CONSTRAINT villages_pkey PRIMARY KEY (village_code);


--
-- Name: yearbook_entries yearbook_entries_academic_year_id_classroom_id_person_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.yearbook_entries
    ADD CONSTRAINT yearbook_entries_academic_year_id_classroom_id_person_id_key UNIQUE (academic_year_id, classroom_id, person_id);


--
-- Name: yearbook_entries yearbook_entries_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.yearbook_entries
    ADD CONSTRAINT yearbook_entries_pkey PRIMARY KEY (id);


--
-- Name: attendance_warnings_academic_year_id_104b4390; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX attendance_warnings_academic_year_id_104b4390 ON public.attendance_warnings USING btree (academic_year_id);


--
-- Name: attendance_warnings_student_id_ba2a6b31; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX attendance_warnings_student_id_ba2a6b31 ON public.attendance_warnings USING btree (student_id);
...
--
-- Name: communes_district_id_7020ddff; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX communes_district_id_7020ddff ON public.communes USING btree (district_id);


--
-- Name: communes_district_id_7020ddff_like; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX communes_district_id_7020ddff_like ON public.communes USING btree (district_id varchar_pattern_ops);


--
-- Name: districts_province_id_bd3d41d9; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX districts_province_id_bd3d41d9 ON public.districts USING btree (province_id);


--
-- Name: districts_province_id_bd3d41d9_like; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX districts_province_id_bd3d41d9_like ON public.districts USING btree (province_id varchar_pattern_ops);
...
--
-- Name: dropout_student_id_58208a47; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX dropout_student_id_58208a47 ON public.dropout USING btree (student_id);
...
CREATE INDEX idx_activity_user ON public.activity_logs USING btree (user_id, created_at);


--
-- Name: idx_att_lookup; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_att_lookup ON public.attendance USING btree (classroom_id, attendance_date);


--
-- Name: idx_att_period; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_att_period ON public.attendance USING btree (student_id, subject_id, academic_year_id);


--
-- Name: idx_att_student; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_att_student ON public.attendance USING btree (student_id, attendance_date);
...
CREATE INDEX idx_audit_target ON public.permission_audit_logs USING btree (target_user_id, created_at);
...
CREATE INDEX idx_audit_user ON public.permission_audit_logs USING btree (user_id, created_at);


--
-- Name: idx_awards_date; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_awards_date ON public.awards USING btree (awarded_date);


--
-- Name: idx_awards_student; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_awards_student ON public.awards USING btree (student_id, academic_year_id);


--
-- Name: idx_awards_type; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_awards_type ON public.awards USING btree (award_type, academic_year_id);


--
-- Name: idx_calendar_class; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_calendar_class ON public.school_calendar USING btree (classroom_id);
...
CREATE INDEX idx_calendar_date ON public.school_calendar USING btree (start_date, end_date);
...
CREATE INDEX idx_calendar_type ON public.school_calendar USING btree (event_type);
...
CREATE INDEX idx_group_members_group ON public.permission_group_members USING btree (group_id);


--
-- Name: idx_monitor_student; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_monitor_student ON public.class_monitors USING btree (student_id);
...
CREATE INDEX idx_notif_unread ON public.notifications USING btree (student_id, is_read);


--
-- Name: idx_payyear_student; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_payyear_student ON public.student_pay_year USING btree (student_id, academic_year_id);


--
-- Name: idx_period_parent; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_period_parent ON public.academic_periods USING btree (parent_id);


--
-- Name: idx_perm_action_code; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_perm_action_code ON public.permission_actions USING btree (action_code);


--
-- Name: idx_perm_log; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_perm_log ON public.monk_permission_logs USING btree (permission_id, created_at);


--
-- Name: idx_perm_resource_code; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_perm_resource_code ON public.permission_resources USING btree (resource_code);


--
-- Name: idx_permission_dates; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_permission_dates ON public.monk_permission USING btree (end_date);


--
-- Name: idx_resource_policy; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_resource_policy ON public.resource_access_policies USING btree (resource_id);


--
-- Name: idx_role_perm_role; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_role_perm_role ON public.role_permissions USING btree (role, is_active);


--
-- Name: idx_score_lookup; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_score_lookup ON public.scores USING btree (student_id, period_id);


--
-- Name: idx_session_subject; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_session_subject ON public.teaching_sessions USING btree (subject_id);
...
CREATE INDEX idx_session_teacher ON public.teaching_sessions USING btree (teacher_id, session_date);


--
-- Name: idx_student_pagoda; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_student_pagoda ON public.students USING btree (current_pagoda_id);


--
-- Name: idx_timetable_lookup; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_timetable_lookup ON public.timetable USING btree (classroom_id, day_no);


--
-- Name: idx_user_perm_expiry; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_user_perm_expiry ON public.user_permissions USING btree (expiry_date);


--
-- Name: idx_user_perm_user; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_user_perm_user ON public.user_permissions USING btree (user_id, is_active);


--
-- Name: idx_yearbook_classroom; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_yearbook_classroom ON public.yearbook_entries USING btree (academic_year_id, classroom_id, entry_type);


--
-- Name: idx_yearbook_person; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_yearbook_person ON public.yearbook_entries USING btree (person_id);


--
-- Name: multiple_permission_student_id_672b2bc4; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX multiple_permission_student_id_672b2bc4 ON public.multiple_permission USING btree (student_id);


--
-- Name: pagodas_commune_id_cf2abc43; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX pagodas_commune_id_cf2abc43 ON public.pagodas USING btree (commune_id);


--
-- Name: pagodas_commune_id_cf2abc43_like; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX pagodas_commune_id_cf2abc43_like ON public.pagodas USING btree (commune_id varchar_pattern_ops);


--
-- Name: pagodas_district_id_4d1289cc; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX pagodas_district_id_4d1289cc ON public.pagodas USING btree (district_id);


--
-- Name: pagodas_district_id_4d1289cc_like; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX pagodas_district_id_4d1289cc_like ON public.pagodas USING btree (district_id varchar_pattern_ops);


--
-- Name: pagodas_province_id_7c03d776; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX pagodas_province_id_7c03d776 ON public.pagodas USING btree (province_id);


--
-- Name: pagodas_province_id_7c03d776_like; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX pagodas_province_id_7c03d776_like ON public.pagodas USING btree (province_id varchar_pattern_ops);


--
-- Name: pagodas_village_id_2dd83aad; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX pagodas_village_id_2dd83aad ON public.pagodas USING btree (village_id);


--
-- Name: pagodas_village_id_2dd83aad_like; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX pagodas_village_id_2dd83aad_like ON public.pagodas USING btree (village_id varchar_pattern_ops);


--
-- Name: pending_students_birth_pagoda_id_cac1eaf1; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX pending_students_birth_pagoda_id_cac1eaf1 ON public.pending_students USING btree (birth_pagoda_id);


--
-- Name: pending_students_birth_village_code_702e7a78; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX pending_students_birth_village_code_702e7a78 ON public.pending_students USING btree (birth_village_code);


--
-- Name: pending_students_birth_village_code_702e7a78_like; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX pending_students_birth_village_code_702e7a78_like ON public.pending_students USING btree (birth_village_code varchar_pattern_ops);


--
-- Name: pending_students_current_pagoda_id_0cd93cc6; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX pending_students_current_pagoda_id_0cd93cc6 ON public.pending_students USING btree (current_pagoda_id);


--
-- Name: pending_students_kuti_id_90b03966; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX pending_students_kuti_id_90b03966 ON public.pending_students USING btree (kuti_id);


--
-- Name: pending_students_nationality_id_4d442d62; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX pending_students_nationality_id_4d442d62 ON public.pending_students USING btree (nationality_id);


--
-- Name: pending_students_tracking_code_c0a0eb81_like; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX pending_students_tracking_code_c0a0eb81_like ON public.pending_students USING btree (tracking_code varchar_pattern_ops);


--
-- Name: pending_teachers_reviewed_by_58ec7045; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX pending_teachers_reviewed_by_58ec7045 ON public.pending_teachers USING btree (reviewed_by);


--
-- Name: pending_teachers_tracking_code_f385a257_like; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX pending_teachers_tracking_code_f385a257_like ON public.pending_teachers USING btree (tracking_code varchar_pattern_ops);


--
-- Name: schedule_substitutions_original_teacher_id_dd907282; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX schedule_substitutions_original_teacher_id_dd907282 ON public.schedule_substitutions USING btree (original_teacher_id);


--
-- Name: students_education_level_id_3d90b742; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX students_education_level_id_3d90b742 ON public.students USING btree (education_level_id);


--
-- Name: villages_commune_id_0a39824a; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX villages_commune_id_0a39824a ON public.villages USING btree (commune_id);


--
-- Name: villages_commune_id_0a39824a_like; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX villages_commune_id_0a39824a_like ON public.villages USING btree (commune_id varchar_pattern_ops);


--
-- Name: attendance trg_attendance_updated; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: awards trg_awards_updated; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: school_calendar trg_calendar_updated; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trg_calendar_updated BEFORE UPDATE ON public.school_calendar FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();
...
--
-- Name: paper_headers trg_paperheaders_updated; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trg_paperheaders_updated BEFORE UPDATE ON public.paper_headers FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();


--
-- Name: pay_rates trg_payrates_updated; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trg_payrates_updated BEFORE UPDATE ON public.pay_rates FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();


--
-- Name: permission_actions trg_perm_actions_updated; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trg_perm_actions_updated BEFORE UPDATE ON public.permission_actions FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();


--
-- Name: permission_groups trg_perm_groups_updated; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trg_perm_groups_updated BEFORE UPDATE ON public.permission_groups FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();


--
-- Name: permission_resources trg_perm_resources_updated; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trg_perm_resources_updated BEFORE UPDATE ON public.permission_resources FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();


--
-- Name: monk_permission trg_permission_updated; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trg_permission_updated BEFORE UPDATE ON public.monk_permission FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();
...
--
-- Name: report_daily trg_report_daily_updated; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trg_report_daily_updated BEFORE UPDATE ON public.report_daily FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();


--
-- Name: resource_access_policies trg_resource_policy_updated; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trg_resource_policy_updated BEFORE UPDATE ON public.resource_access_policies FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();


--
-- Name: role_permissions trg_role_permissions_updated; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trg_role_permissions_updated BEFORE UPDATE ON public.role_permissions FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();


--
-- Name: student_pay_year trg_student_pay_year_updated; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trg_student_pay_year_updated BEFORE UPDATE ON public.student_pay_year FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();
...
--
-- Name: teachers trg_teachers_updated; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: user_permissions trg_user_permissions_updated; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trg_user_permissions_updated BEFORE UPDATE ON public.user_permissions FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();
...
--
-- Name: yearbook_entries trg_yearbook_updated; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trg_yearbook_updated BEFORE UPDATE ON public.yearbook_entries FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();


--
-- Name: monthly_payrolls update_monthly_payrolls_modtime; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER update_monthly_payrolls_modtime BEFORE UPDATE ON public.monthly_payrolls FOR EACH ROW EXECUTE FUNCTION public.update_modified_column();


--
-- Name: payroll_rates update_payroll_rates_modtime; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER update_payroll_rates_modtime BEFORE UPDATE ON public.payroll_rates FOR EACH ROW EXECUTE FUNCTION public.update_modified_column();
...
ALTER TABLE ONLY public.academic_periods
    ADD CONSTRAINT academic_periods_academic_year_id_fkey FOREIGN KEY (academic_year_id) REFERENCES public.academic_years(id) ON DELETE CASCADE;


--
-- Name: academic_periods academic_periods_parent_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.academic_periods
    ADD CONSTRAINT academic_periods_parent_id_fkey FOREIGN KEY (parent_id) REFERENCES public.academic_periods(id) ON DELETE CASCADE;
...
--
-- Name: attendance attendance_academic_year_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: attendance attendance_classroom_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: attendance attendance_recorded_by_monitor_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.attendance
    ADD CONSTRAINT attendance_recorded_by_monitor_id_fkey FOREIGN KEY (recorded_by_monitor_id) REFERENCES public.students(id) ON DELETE SET NULL;


--
-- Name: attendance attendance_recorded_by_teacher_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.attendance
    ADD CONSTRAINT attendance_recorded_by_teacher_id_fkey FOREIGN KEY (recorded_by_teacher_id) REFERENCES public.teachers(id) ON DELETE SET NULL;
...
--
-- Name: attendance_warnings attendance_warnings_academic_year_id_104b4390_fk_academic_; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.attendance_warnings
    ADD CONSTRAINT attendance_warnings_academic_year_id_104b4390_fk_academic_ FOREIGN KEY (academic_year_id) REFERENCES public.academic_years(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: attendance_warnings attendance_warnings_student_id_ba2a6b31_fk_students_id; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.attendance_warnings
    ADD CONSTRAINT attendance_warnings_student_id_ba2a6b31_fk_students_id FOREIGN KEY (student_id) REFERENCES public.students(id) DEFERRABLE INITIALLY DEFERRED;
...
--
-- Name: authtoken_token authtoken_token_user_id_35299eff_fk_users_id; Type: FK CONSTRAINT; Schema: public; Owner: admin
--
...
--
-- Name: awards awards_academic_year_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.awards
    ADD CONSTRAINT awards_academic_year_id_fkey FOREIGN KEY (academic_year_id) REFERENCES public.academic_years(id) ON DELETE CASCADE;


--
-- Name: awards awards_awarded_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.awards
    ADD CONSTRAINT awards_awarded_by_fkey FOREIGN KEY (awarded_by) REFERENCES public.teachers(id) ON DELETE SET NULL;


--
-- Name: awards awards_student_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: class_monitors class_monitors_academic_year_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.class_monitors
    ADD CONSTRAINT class_monitors_academic_year_id_fkey FOREIGN KEY (academic_year_id) REFERENCES public.academic_years(id);


--
-- Name: class_monitors class_monitors_classroom_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.class_monitors
    ADD CONSTRAINT class_monitors_classroom_id_fkey FOREIGN KEY (classroom_id) REFERENCES public.classrooms(id) ON DELETE CASCADE;


--
-- Name: class_monitors class_monitors_student_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.class_monitors
    ADD CONSTRAINT class_monitors_student_id_fkey FOREIGN KEY (student_id) REFERENCES public.students(id) ON DELETE CASCADE;


--
-- Name: class_subjects class_subjects_classroom_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.class_subjects
    ADD CONSTRAINT class_subjects_classroom_id_fkey FOREIGN KEY (classroom_id) REFERENCES public.classrooms(id) ON DELETE CASCADE;
...
--
-- Name: class_subjects class_subjects_teacher_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: classrooms classrooms_homeroom_teacher_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.classrooms
    ADD CONSTRAINT classrooms_homeroom_teacher_id_fkey FOREIGN KEY (homeroom_teacher_id) REFERENCES public.teachers(id) ON DELETE SET NULL;


--
-- Name: communes communes_district_id_7020ddff_fk_districts_district_code; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.communes
    ADD CONSTRAINT communes_district_id_7020ddff_fk_districts_district_code FOREIGN KEY (district_id) REFERENCES public.districts(district_code) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: districts districts_province_id_bd3d41d9_fk_provinces_province_code; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.districts
    ADD CONSTRAINT districts_province_id_bd3d41d9_fk_provinces_province_code FOREIGN KEY (province_id) REFERENCES public.provinces(province_code) DEFERRABLE INITIALLY DEFERRED;
...
--
-- Name: django_admin_log django_admin_log_user_id_c564eba6_fk_users_id; Type: FK CONSTRAINT; Schema: public; Owner: admin
--
...
--
-- Name: dropout dropout_student_id_58208a47_fk_students_id; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.dropout
    ADD CONSTRAINT dropout_student_id_58208a47_fk_students_id FOREIGN KEY (student_id) REFERENCES public.students(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: enrollments enrollments_academic_year_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: enrollments enrollments_classroom_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.enrollments
    ADD CONSTRAINT enrollments_classroom_id_fkey FOREIGN KEY (classroom_id) REFERENCES public.classrooms(id);
...
--
-- Name: final_scores final_scores_period_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.final_scores
    ADD CONSTRAINT final_scores_period_id_fkey FOREIGN KEY (period_id) REFERENCES public.academic_periods(id);


--
-- Name: final_scores final_scores_student_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.final_scores
    ADD CONSTRAINT final_scores_student_id_fkey FOREIGN KEY (student_id) REFERENCES public.students(id) ON DELETE CASCADE;


--
-- Name: final_scores final_scores_subject_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.final_scores
    ADD CONSTRAINT final_scores_subject_id_fkey FOREIGN KEY (subject_id) REFERENCES public.subjects(id);


--
-- Name: kutis kutis_pagoda_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.kutis
    ADD CONSTRAINT kutis_pagoda_id_fkey FOREIGN KEY (pagoda_id) REFERENCES public.pagodas(id) ON DELETE CASCADE;


--
-- Name: monk_permission_logs monk_permission_logs_performed_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.monk_permission_logs
    ADD CONSTRAINT monk_permission_logs_performed_by_fkey FOREIGN KEY (performed_by) REFERENCES public.teachers(id) ON DELETE SET NULL;


--
-- Name: monk_permission_logs monk_permission_logs_performed_by_monitor_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.monk_permission_logs
    ADD CONSTRAINT monk_permission_logs_performed_by_monitor_fkey FOREIGN KEY (performed_by_monitor) REFERENCES public.students(id) ON DELETE SET NULL;


--
-- Name: monk_permission_logs monk_permission_logs_permission_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.monk_permission_logs
    ADD CONSTRAINT monk_permission_logs_permission_id_fkey FOREIGN KEY (permission_id) REFERENCES public.monk_permission(id) ON DELETE CASCADE;


--
-- Name: monk_permission monk_permission_monk_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.monk_permission
    ADD CONSTRAINT monk_permission_monk_id_fkey FOREIGN KEY (monk_id) REFERENCES public.students(id) ON DELETE CASCADE;


--
-- Name: monk_permission monk_permission_reviewed_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.monk_permission
    ADD CONSTRAINT monk_permission_reviewed_by_fkey FOREIGN KEY (reviewed_by) REFERENCES public.teachers(id) ON DELETE SET NULL;


--
-- Name: monk_permission monk_permission_reviewed_by_monitor_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.monk_permission
    ADD CONSTRAINT monk_permission_reviewed_by_monitor_fkey FOREIGN KEY (reviewed_by_monitor) REFERENCES public.students(id) ON DELETE SET NULL;


--
-- Name: monthly_payrolls monthly_payrolls_academic_period_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.monthly_payrolls
    ADD CONSTRAINT monthly_payrolls_academic_period_id_fkey FOREIGN KEY (academic_period_id) REFERENCES public.academic_periods(id) ON DELETE CASCADE;


--
-- Name: monthly_payrolls monthly_payrolls_subject_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.monthly_payrolls
    ADD CONSTRAINT monthly_payrolls_subject_id_fkey FOREIGN KEY (subject_id) REFERENCES public.subjects(id) ON DELETE CASCADE;


--
-- Name: monthly_payrolls monthly_payrolls_teacher_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.monthly_payrolls
    ADD CONSTRAINT monthly_payrolls_teacher_id_fkey FOREIGN KEY (teacher_id) REFERENCES public.teachers(id) ON DELETE CASCADE;


--
-- Name: multiple_permission multiple_permission_student_id_672b2bc4_fk_students_id; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.multiple_permission
    ADD CONSTRAINT multiple_permission_student_id_672b2bc4_fk_students_id FOREIGN KEY (student_id) REFERENCES public.students(id) DEFERRABLE INITIALLY DEFERRED;
...
--
-- Name: pagodas pagodas_commune_id_cf2abc43_fk_communes_commune_code; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.pagodas
    ADD CONSTRAINT pagodas_commune_id_cf2abc43_fk_communes_commune_code FOREIGN KEY (commune_id) REFERENCES public.communes(commune_code) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: pagodas pagodas_district_id_4d1289cc_fk_districts_district_code; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.pagodas
    ADD CONSTRAINT pagodas_district_id_4d1289cc_fk_districts_district_code FOREIGN KEY (district_id) REFERENCES public.districts(district_code) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: pagodas pagodas_province_id_7c03d776_fk_provinces_province_code; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.pagodas
    ADD CONSTRAINT pagodas_province_id_7c03d776_fk_provinces_province_code FOREIGN KEY (province_id) REFERENCES public.provinces(province_code) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: pagodas pagodas_village_id_2dd83aad_fk_villages_village_code; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.pagodas
    ADD CONSTRAINT pagodas_village_id_2dd83aad_fk_villages_village_code FOREIGN KEY (village_id) REFERENCES public.villages(village_code) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: pay_rates pay_rates_subject_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.pay_rates
    ADD CONSTRAINT pay_rates_subject_id_fkey FOREIGN KEY (subject_id) REFERENCES public.subjects(id) ON DELETE CASCADE;


--
-- Name: payroll_rates payroll_rates_academic_period_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.payroll_rates
    ADD CONSTRAINT payroll_rates_academic_period_id_fkey FOREIGN KEY (academic_period_id) REFERENCES public.academic_periods(id) ON DELETE SET NULL;


--
-- Name: payroll_rates payroll_rates_class_subject_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.payroll_rates
    ADD CONSTRAINT payroll_rates_class_subject_id_fkey FOREIGN KEY (class_subject_id) REFERENCES public.class_subjects(id) ON DELETE CASCADE;


--
-- Name: pending_students pending_students_birth_pagoda_id_cac1eaf1_fk_pagodas_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.pending_students
    ADD CONSTRAINT pending_students_birth_pagoda_id_cac1eaf1_fk_pagodas_id FOREIGN KEY (birth_pagoda_id) REFERENCES public.pagodas(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: pending_students pending_students_birth_village_code_702e7a78_fk_villages_; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.pending_students
    ADD CONSTRAINT pending_students_birth_village_code_702e7a78_fk_villages_ FOREIGN KEY (birth_village_code) REFERENCES public.villages(village_code) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: pending_students pending_students_current_pagoda_id_0cd93cc6_fk_pagodas_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.pending_students
    ADD CONSTRAINT pending_students_current_pagoda_id_0cd93cc6_fk_pagodas_id FOREIGN KEY (current_pagoda_id) REFERENCES public.pagodas(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: pending_students pending_students_kuti_id_90b03966_fk_kutis_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.pending_students
    ADD CONSTRAINT pending_students_kuti_id_90b03966_fk_kutis_id FOREIGN KEY (kuti_id) REFERENCES public.kutis(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: pending_students pending_students_nationality_id_4d442d62_fk_nationalities_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.pending_students
    ADD CONSTRAINT pending_students_nationality_id_4d442d62_fk_nationalities_id FOREIGN KEY (nationality_id) REFERENCES public.nationalities(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: pending_students pending_students_reviewed_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.pending_students
    ADD CONSTRAINT pending_students_reviewed_by_fkey FOREIGN KEY (reviewed_by) REFERENCES public.users(id) ON DELETE SET NULL;


--
-- Name: pending_teachers pending_teachers_reviewed_by_58ec7045_fk_users_id; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.pending_teachers
    ADD CONSTRAINT pending_teachers_reviewed_by_58ec7045_fk_users_id FOREIGN KEY (reviewed_by) REFERENCES public.users(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: permission_audit_logs permission_audit_logs_action_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.permission_audit_logs
    ADD CONSTRAINT permission_audit_logs_action_id_fkey FOREIGN KEY (action_id) REFERENCES public.permission_actions(id) ON DELETE SET NULL;


--
-- Name: permission_audit_logs permission_audit_logs_permission_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.permission_audit_logs
    ADD CONSTRAINT permission_audit_logs_permission_id_fkey FOREIGN KEY (permission_id) REFERENCES public.permissions(id) ON DELETE SET NULL;


--
-- Name: permission_audit_logs permission_audit_logs_resource_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.permission_audit_logs
    ADD CONSTRAINT permission_audit_logs_resource_id_fkey FOREIGN KEY (resource_id) REFERENCES public.permission_resources(id) ON DELETE SET NULL;


--
-- Name: permission_audit_logs permission_audit_logs_target_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.permission_audit_logs
    ADD CONSTRAINT permission_audit_logs_target_user_id_fkey FOREIGN KEY (target_user_id) REFERENCES public.users(id) ON DELETE SET NULL;
...
ALTER TABLE ONLY public.permission_audit_logs
    ADD CONSTRAINT permission_audit_logs_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;


--
-- Name: permission_group_members permission_group_members_group_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.permission_group_members
    ADD CONSTRAINT permission_group_members_group_id_fkey FOREIGN KEY (group_id) REFERENCES public.permission_groups(id) ON DELETE CASCADE;


--
-- Name: permission_group_members permission_group_members_permission_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.permission_group_members
    ADD CONSTRAINT permission_group_members_permission_id_fkey FOREIGN KEY (permission_id) REFERENCES public.permissions(id) ON DELETE CASCADE;


--
-- Name: permissions permissions_action_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.permissions
    ADD CONSTRAINT permissions_action_id_fkey FOREIGN KEY (action_id) REFERENCES public.permission_actions(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.permissions
    ADD CONSTRAINT permissions_resource_id_fkey FOREIGN KEY (resource_id) REFERENCES public.permission_resources(id) ON DELETE CASCADE;


--
-- Name: positions positions_parent_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: report_daily report_daily_reported_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.report_daily
    ADD CONSTRAINT report_daily_reported_by_fkey FOREIGN KEY (reported_by) REFERENCES public.users(id) ON DELETE SET NULL;


--
-- Name: resource_access_policies resource_access_policies_resource_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.resource_access_policies
    ADD CONSTRAINT resource_access_policies_resource_id_fkey FOREIGN KEY (resource_id) REFERENCES public.permission_resources(id) ON DELETE CASCADE;
...
--
-- Name: schedule_substitutions schedule_substitutio_original_teacher_id_dd907282_fk_teachers_; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.schedule_substitutions
    ADD CONSTRAINT schedule_substitutio_original_teacher_id_dd907282_fk_teachers_ FOREIGN KEY (original_teacher_id) REFERENCES public.teachers(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: schedule_substitutions schedule_substitutions_classroom_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.schedule_substitutions
    ADD CONSTRAINT schedule_substitutions_classroom_id_fkey FOREIGN KEY (classroom_id) REFERENCES public.classrooms(id) ON DELETE CASCADE;


--
-- Name: schedule_substitutions schedule_substitutions_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.schedule_substitutions
    ADD CONSTRAINT schedule_substitutions_created_by_fkey FOREIGN KEY (created_by) REFERENCES public.teachers(id) ON DELETE SET NULL;


--
-- Name: schedule_substitutions schedule_substitutions_new_subject_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.schedule_substitutions
    ADD CONSTRAINT schedule_substitutions_new_subject_id_fkey FOREIGN KEY (new_subject_id) REFERENCES public.subjects(id);


--
-- Name: schedule_substitutions schedule_substitutions_new_teacher_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.schedule_substitutions
    ADD CONSTRAINT schedule_substitutions_new_teacher_id_fkey FOREIGN KEY (new_teacher_id) REFERENCES public.teachers(id) ON DELETE SET NULL;


--
-- Name: schedule_substitutions schedule_substitutions_original_subject_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.schedule_substitutions
    ADD CONSTRAINT schedule_substitutions_original_subject_id_fkey FOREIGN KEY (original_subject_id) REFERENCES public.subjects(id);


--
-- Name: schedule_substitutions schedule_substitutions_time_slot_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.schedule_substitutions
    ADD CONSTRAINT schedule_substitutions_time_slot_id_fkey FOREIGN KEY (time_slot_id) REFERENCES public.time_slots(id);


--
-- Name: school_calendar school_calendar_classroom_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.school_calendar
    ADD CONSTRAINT school_calendar_classroom_id_fkey FOREIGN KEY (classroom_id) REFERENCES public.classrooms(id) ON DELETE CASCADE;


--
-- Name: school_calendar school_calendar_organizer_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.school_calendar
    ADD CONSTRAINT school_calendar_organizer_id_fkey FOREIGN KEY (organizer_id) REFERENCES public.teachers(id) ON DELETE SET NULL;


--
-- Name: scores scores_period_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.scores
    ADD CONSTRAINT scores_period_id_fkey FOREIGN KEY (period_id) REFERENCES public.academic_periods(id);
...
--
-- Name: scores scores_subject_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.scores
    ADD CONSTRAINT scores_subject_id_fkey FOREIGN KEY (subject_id) REFERENCES public.subjects(id);


--
-- Name: staff_positions staff_positions_position_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.staff_positions
    ADD CONSTRAINT staff_positions_position_id_fkey FOREIGN KEY (position_id) REFERENCES public.positions(id) ON DELETE CASCADE;


--
-- Name: staff_positions staff_positions_teacher_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.staff_positions
    ADD CONSTRAINT staff_positions_teacher_id_fkey FOREIGN KEY (teacher_id) REFERENCES public.teachers(id) ON DELETE CASCADE;


--
-- Name: student_education student_education_student_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.student_education
    ADD CONSTRAINT student_education_student_id_fkey FOREIGN KEY (student_id) REFERENCES public.students(id) ON DELETE CASCADE;


--
-- Name: student_pay_year student_pay_year_academic_year_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.student_pay_year
    ADD CONSTRAINT student_pay_year_academic_year_id_fkey FOREIGN KEY (academic_year_id) REFERENCES public.academic_years(id) ON DELETE RESTRICT;


--
-- Name: student_pay_year student_pay_year_recorded_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.student_pay_year
    ADD CONSTRAINT student_pay_year_recorded_by_fkey FOREIGN KEY (recorded_by) REFERENCES public.users(id) ON DELETE SET NULL;


--
-- Name: student_pay_year student_pay_year_student_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.student_pay_year
    ADD CONSTRAINT student_pay_year_student_id_fkey FOREIGN KEY (student_id) REFERENCES public.students(id) ON DELETE CASCADE;


--
-- Name: students students_birth_pagoda_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.students
    ADD CONSTRAINT students_birth_pagoda_id_fkey FOREIGN KEY (birth_pagoda_id) REFERENCES public.pagodas(id) ON DELETE SET NULL;


--
-- Name: students students_birth_village_code_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.students
    ADD CONSTRAINT students_birth_village_code_fkey FOREIGN KEY (birth_village_code) REFERENCES public.villages(village_code);


--
-- Name: students students_current_pagoda_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.students
    ADD CONSTRAINT students_current_pagoda_id_fkey FOREIGN KEY (current_pagoda_id) REFERENCES public.pagodas(id) ON DELETE SET NULL;


--
-- Name: students students_education_level_id_3d90b742_fk_education_levels_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.students
    ADD CONSTRAINT students_education_level_id_3d90b742_fk_education_levels_id FOREIGN KEY (education_level_id) REFERENCES public.education_levels(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: students students_kuti_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.students
    ADD CONSTRAINT students_kuti_id_fkey FOREIGN KEY (kuti_id) REFERENCES public.kutis(id) ON DELETE SET NULL;
...
--
-- Name: teacher_education teacher_education_teacher_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.teacher_education
    ADD CONSTRAINT teacher_education_teacher_id_fkey FOREIGN KEY (teacher_id) REFERENCES public.teachers(id) ON DELETE CASCADE;


--
-- Name: teacher_salaries teacher_salaries_academic_year_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.teacher_salaries
    ADD CONSTRAINT teacher_salaries_academic_year_id_fkey FOREIGN KEY (academic_year_id) REFERENCES public.academic_years(id);


--
-- Name: teacher_salaries teacher_salaries_subject_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.teacher_salaries
    ADD CONSTRAINT teacher_salaries_subject_id_fkey FOREIGN KEY (subject_id) REFERENCES public.subjects(id);


--
-- Name: teacher_salaries teacher_salaries_teacher_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.teacher_salaries
    ADD CONSTRAINT teacher_salaries_teacher_id_fkey FOREIGN KEY (teacher_id) REFERENCES public.teachers(id) ON DELETE CASCADE;


--
-- Name: teaching_sessions teaching_sessions_classroom_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.teaching_sessions
    ADD CONSTRAINT teaching_sessions_classroom_id_fkey FOREIGN KEY (classroom_id) REFERENCES public.classrooms(id);


--
-- Name: teaching_sessions teaching_sessions_subject_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.teaching_sessions
    ADD CONSTRAINT teaching_sessions_subject_id_fkey FOREIGN KEY (subject_id) REFERENCES public.subjects(id);


--
-- Name: teaching_sessions teaching_sessions_substitution_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.teaching_sessions
    ADD CONSTRAINT teaching_sessions_substitution_id_fkey FOREIGN KEY (substitution_id) REFERENCES public.schedule_substitutions(id);


--
-- Name: teaching_sessions teaching_sessions_teacher_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.teaching_sessions
    ADD CONSTRAINT teaching_sessions_teacher_id_fkey FOREIGN KEY (teacher_id) REFERENCES public.teachers(id);


--
-- Name: teaching_sessions teaching_sessions_time_slot_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.teaching_sessions
    ADD CONSTRAINT teaching_sessions_time_slot_id_fkey FOREIGN KEY (time_slot_id) REFERENCES public.time_slots(id);


--
-- Name: timetable timetable_academic_year_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
ALTER TABLE ONLY public.timetable
    ADD CONSTRAINT timetable_classroom_id_fkey FOREIGN KEY (classroom_id) REFERENCES public.classrooms(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.timetable
    ADD CONSTRAINT timetable_time_slot_id_fkey FOREIGN KEY (time_slot_id) REFERENCES public.time_slots(id);
...
ALTER TABLE ONLY public.users
    ADD CONSTRAINT users_student_id_fkey FOREIGN KEY (student_id) REFERENCES public.students(id) ON DELETE CASCADE;
...
--
-- Name: villages villages_commune_id_0a39824a_fk_communes_commune_code; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.villages
    ADD CONSTRAINT villages_commune_id_0a39824a_fk_communes_commune_code FOREIGN KEY (commune_id) REFERENCES public.communes(commune_code) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: yearbook_entries yearbook_entries_academic_year_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.yearbook_entries
    ADD CONSTRAINT yearbook_entries_academic_year_id_fkey FOREIGN KEY (academic_year_id) REFERENCES public.academic_years(id) ON DELETE CASCADE;


--
-- Name: yearbook_entries yearbook_entries_classroom_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.yearbook_entries
    ADD CONSTRAINT yearbook_entries_classroom_id_fkey FOREIGN KEY (classroom_id) REFERENCES public.classrooms(id) ON DELETE CASCADE;


--
-- Name: yearbook_entries yearbook_entries_person_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.yearbook_entries
    ADD CONSTRAINT yearbook_entries_person_id_fkey FOREIGN KEY (person_id) REFERENCES public.students(id) ON DELETE SET NULL;


--
-- Name: yearbook_entries yearbook_entries_uploaded_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.yearbook_entries
    ADD CONSTRAINT yearbook_entries_uploaded_by_fkey FOREIGN KEY (uploaded_by) REFERENCES public.teachers(id) ON DELETE SET NULL;
...
\unrestrict MC96NDxsErhKVrGQMWoopgdM0gZeWa7nSWpBbbqchbYgLauajUQhpVPjr0QzC3H
